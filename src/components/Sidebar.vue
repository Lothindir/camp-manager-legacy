<template>
  <div
    v-bind:class="(isOpen ? 'w-56' : 'w-12')"
    class="bg-gray-800 text-white border-r border-b border-black fixed min-h-screen pt-8 top-0 z-40"
  >
    ...
    <div v-if="isOpen" class="search-container text-center p-3 relative">
      <input
        class="bg-gray-600 text-gray-100 text-xs w-full p-2 pl-8 border-gray-700 rounded"
    ...
    <router-link to="/config" class="sidebar-icons">
      <SidebarMenu v-bind:is-open="isOpen" icon="font-awesome/gears" text="Réglages"></SidebarMenu>
    </router-link>
